...
class Config:
    ...
    # ==================== 静态资源路径 ====================
    MAIN_STATIC_FOLDER = BASE_DIR / 'static' # 主业务静态资源
    STORAGE_FOLDER = BASE_DIR / 'storage' # 存储目录
    
    # ==================== 视频处理路径 ====================
    ARTICLE_DIR = STORAGE_FOLDER / 'output' / 'articles'  # 文章工作区
    OUTPUT_DIR = STORAGE_FOLDER / 'output' / 'outputs'   # 视频输出
    TEXT_DIR = STORAGE_FOLDER / 'output' / 'txt'            # 文本输入目录
